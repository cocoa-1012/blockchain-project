...
interface HistoryEventSellerMigratedProps extends HistoryEventProps {
  label: string;
}

export default function HistoryEventSellerMigrated(
  props: HistoryEventSellerMigratedProps
): JSX.Element {
