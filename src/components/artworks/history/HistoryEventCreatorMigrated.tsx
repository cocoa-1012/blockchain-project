...
interface HistoryEventCreatorMigratedProps extends HistoryEventProps {
  label: string;
}

export default function HistoryEventCreatorMigrated(
  props: HistoryEventCreatorMigratedProps
): JSX.Element {
