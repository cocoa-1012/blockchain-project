...
import { ArtworkWithEvent } from 'types/Artwork';
...
interface ArtworkCardNoEventProps {
  className?: string;
  artwork: ArtworkWithEvent;
  creator: Creator;
  event?: ArtworkWithEvent['event'];
  isOwner?: boolean;
  currentUser?: Account;
...
export default function ArtworkCardNoEvent(
  props: ArtworkCardNoEventProps
): JSX.Element {
  const {
    className,
    artwork,
